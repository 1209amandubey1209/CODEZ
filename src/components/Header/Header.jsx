      ...
      <div className="container-fluid nav sticky-top">
        <div className="row col-12">
          <div className=" row align-items-center flex-md-row flex-column align-items-stretch col-xl-8 col-md-9 col-6 " >
            ...
            <NavLink to='/exerciseslist' className="header-navlink col col-lg-2 d-none d-md-block col-3 pt-3 text-center ">Exercises<ArrowDropDownIcon/></ NavLink>
            <NavLink to='/getcertifiedlist'  className="header-navlink col col-lg-3  pt-3 text-center d-none d-lg-block ">Get Certified<ArrowDropDownIcon/></ NavLink>
            <NavLink to='/serviceslist' className="header-navlink col col-xl-2  pt-3 d-none d-xl-block text-center " >Services<ArrowDropDownIcon/></NavLink>
