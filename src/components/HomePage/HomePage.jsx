    ...
    <>
      <div className="container-fluid ">
        ...
        >
          <div className="col-md-6 col flex-column  ">
            <div className="row course-section text-center flex-column">
              ...
              <NavLink to='/htmltutorial' className="tutorial-btn mx-auto my-5 bg-success">
                Learn HTML
              </NavLink>
              <NavLink to='/htmlvideo' className="tutorial-btn mx-auto bg-danger">
                video Tutorial
              </NavLink>
            </div>
          </div>
        ...
        >
          <div className="col-md-6 col flex-column ">
            <div className="row course-section text-center flex-column">
              ...
              <NavLink to='/csstutorial' className="tutorial-btn mx-auto my-5 bg-success">
                Learn CSS
              </NavLink>
              <NavLink to='/cssvideo' className="tutorial-btn mx-auto bg-danger">
                video Tutorial
              </NavLink>
            </div>
          </div>
        ...
        >
          <div className="col-md-6 col flex-column ">
            <div className="row course-section text-center flex-column">
              ...
              <NavLink to='/jstutorial' className="tutorial-btn mx-auto my-5 bg-success">
                Learn JS
              </NavLink>
              <NavLink to='/javascriptvideo' className="tutorial-btn mx-auto bg-danger">
                video Tutorial
              </NavLink>
            </div>
          </div>
        ...
        >
          <div className="col-md-6 col flex-column ">
            <div className="row course-section text-center flex-column">
              ...
              <NavLink to='/pythontutorial' className="tutorial-btn mx-auto my-5 bg-success">
                Learn Python
              </NavLink>
              <NavLink to="/pythonvideo" className="tutorial-btn mx-auto bg-danger">
                video Tutorial
              </NavLink>
            </div>
          </div>
        ...
        >
          <div className="col-md-6 col  flex-column ">
            <div className="row course-section text-center flex-column">
              ...
              <NavLink to='/reacttutorial' className="tutorial-btn mx-auto my-5 bg-success">
                Learn React
              </NavLink>
              <NavLink to='/reactvideo' className="tutorial-btn mx-auto bg-danger">
                video Tutorial
              </NavLink>
            </div>
          </div>
       ...
       <div className="row second-course-section">
        ...
        <NavLink to='/phptutorial' className=" col-8 col-lg-5 course my-4 text-center" style={{backgroundColor:"#89CFF0"}}>
          PHP <br />          
          <code>A general-purpose scripting language</code>
        </NavLink>
        
        <NavLink to='/c++tutorial' className=" col-8 col-lg-5 course my-4 text-center" style={{backgroundColor:"#7393B3"}}>C++ <br />
        <code> A high-level , general-purpose programming language</code>
        </NavLink>
        <NavLink to='/jquerytutorial' className=" col-8 col-lg-5 course my-4 text-center" style={{backgroundColor:"#96DED1"}}>jQuery <br />
        <code>A JavaScript library designed to simplify HTML DOM</code>
        </NavLink>
        <NavLink to='/javatutorial' className=" col-8 col-lg-5 course my-4 text-center" style={{backgroundColor:"#FA5F55"}}>Java <br />
